...
var apiKey = '178c8d67c72e98b360eb26368e25e814';
var requestToken;
var username;
var password;
var sessionId;
...
searchButton === null || searchButton === void 0 ? void 0 : searchButton.addEventListener('click', function () { return __awaiter(void 0, void 0, void 0, function () {
    var lista, querys, valor, listaDeFilmes, ul, _i, _a, item, li;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                querys = document.getElementById('search');
                valor = querys.value;
                return [4 /*yield*/, procurarFilme(valor)];
            case 1:
...
function preencherApi() {
    var senha = document.getElementById('api-key');
    apiKey = senha.value;
    validateLoginButton();
}
